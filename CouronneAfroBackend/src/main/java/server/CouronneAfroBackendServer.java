...
import api.exceptionmapper.IllegalPasswordFormatExceptionMapper;
import api.exceptionmapper.InvalidTokenServiceExceptionMapper;
import api.exceptionmapper.PersistenceInternalErrorServiceExceptionMapper;
...
import server.database.configuration.Database;
...
public class CouronneAfroBackendServer {

	private static final Logger SERVER_LOGGER =Logger.getLogger(CouronneAfroBackendServer.class.getName());
	...
	public static void main(String[] args) throws Exception{
		...
		CouronneAfroBackendServer server = new CouronneAfroBackendServer();
	...
	private ContextHandlerCollection configureJersey(ServletContextHandler servletContext, Context applicationContext) {
		...
		}).register(PersistenceInternalErrorServiceExceptionMapper.class)
				.register(InvalidTokenServiceExceptionMapper.class)
				.register(IllegalPasswordFormatExceptionMapper.class)
